    ...
    <div className="description-page">
      ...
      <footer className="login-footer">
        <div className="login-footer-inner">
          ...
          <div>
              ...
              <div className="login-footer-links">
                ...
                <a href="/gifting">Gift Boxes</a>
                <a href="/contact">Contact</a>
              </div>
            </div>
            <div>
              <p className="login-footer-col-title">Account</p>
              <div className="login-footer-links">
            ...
            <div>
              <p className="login-footer-col-title">Legal</p>
              <div className="login-footer-links">
        ...
        <div className="login-footer-bottom">
          <span>&copy; 2025 AjwaHub. All rights reserved.</span>
          <div className="login-footer-payments">
              {paymentIcons.map((icon, i) => (
                <div key={i} className="pay-icon">
                  <img src={icon} alt={`pay-${i}`} onError={e => e.target.style.display='none'} />
                </div>
              ))}
            </div>
          <span className="login-footer-bottom-right">Made with <svg width="14" height="14" viewBox="0 0 24 24" fill="#ef4444" style={{verticalAlign:'middle', margin:'0 2px'}}><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg> in Pakistan</span>
        </div>
      </footer>
    </div>
  );
